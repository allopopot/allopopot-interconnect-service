...
var p = &params{
	memory:      config.ARGON2ID_MEMORY,
	iterations:  config.ARGON2ID_ITERATION,
	parallelism: config.ARGON2ID_PARALLELISM,
	saltLength:  config.ARGON2ID_SALT_LENGTH,
	keyLength:   config.ARGON2ID_KEY_LENGTH,
}
